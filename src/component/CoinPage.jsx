...
const CoinPage = () => {
  ...
  const requestOptions = {
    ...
    headers: {
      ...
      "x-cg-demo-api-key": "CG-FNPKEc2QRrqiUiTYA2hVixVD",
    },
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-900/95 to-gray-900/90 text-white px-4 sm:px-[5%] md:px-[8%] py-6">
      ...
      <div className="mb-6 bg-gray-800/30 backdrop-blur-md p-4 rounded-xl border border-emerald-500/20">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 gap-2">
          <h2 className="text-lg font-semibold text-yellow-400/50">
          ...
          <div className="relative group">
            ...
            <div className="absolute -inset-0.5 bg-gradient-to-r from-yellow-600/20 to-orange-500/20 rounded-lg blur opacity-30 group-hover:opacity-50 transition duration-300 -z-10" />
          </div>
        </div>
      ...
      <div className="space-y-3 md:hidden">
        <div className="bg-gray-800/30 backdrop-blur-md p-4 rounded-lg border border-yellow-500/20">
          <div className="flex justify-between items-center">
            <span className="text-sm text-yellow-400/50">Current Price</span>
        ...
        <div className="bg-gray-800/30 backdrop-blur-md p-4 rounded-lg border  border-yellow-500/20">
          <div className="flex justify-between items-center">
            <span className="text-sm text-yellow-400/50">Market Cap</span>
            <span className="text-lg font-bold text-emerald-400">
              {currentCurrency.symbol}
        ...
        <div className="bg-gray-800/30 backdrop-blur-md p-4 rounded-lg border  border-yellow-500/20">
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-sm text-yellow-400/50">24H High</span>
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-yellow-400/50">24H Low</span>
